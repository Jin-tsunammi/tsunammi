...
type SmartBuybackStatus string

const (
	SmartBuybackCampaignStatusActive = "ACTIVE"
	SmartBuybackCampaignStatusDone   = "DONE"
	SmartBuybackCampaignStatusError  = "ERROR"
)
...
type SwapCampaignTargetStatus string

const (
	SmartBuybackTargetStatusScheduled  = "SCHEDULED"
	SmartBuybackTargetStatusActive     = "ACTIVE"
	SmartBuybackTargetStatusDone       = "DONE"
	SmartBuybackTargetStatusBudgetDone = "BUDGET_DONE"
)
...
type SmartBuybackCampaignTarget struct {
	...
	MinTransactionAmount       mtype.BigRat              `bun:"min_transactions_amount" json:"min_transactions_budget" swaggertype:"string"`
	MaxTransactionAmount       mtype.BigRat              `bun:"max_transactions_amount" json:"max_transactions_budget" swaggertype:"string"`
